...
<body class="h-full">
    ...
    <div class="min-h-full">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link href="jobs" aria-current="page"   :active="request()->is('jobs')">Jobs</x-nav-link>
                                <x-nav-link href="contacts" aria-current="page" :active="request()->is ('contacts')">Contact Us</x-nav-link>
        ...
        <div class="px-10 font-bold text-gray-700 ">
        {{ $slot }}
        </div>
    </div>
